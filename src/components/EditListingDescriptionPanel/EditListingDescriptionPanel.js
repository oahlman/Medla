  ...
  return isJob ? (
    <div className={classes}>
      ...
      <EditListingDescriptionForm
        className={css.form}
        initialValues={{ title, description, category: publicData.category, contactNumber: publicData.contactNumber }}
        saveActionMsg={submitButtonText}
        onSubmit={values => {
          const { title, description, category, contactNumber } = values;
          const updateValues = {
            title: title.trim(),
            description,
            publicData: {
