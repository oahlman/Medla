...
const LayoutWrapperAccountSettingsSideNavComponent = props => {
  ...
  const tabs = [
    {
      text: <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.notificationSettingsTabTitle" />,
      selected: currentTab === 'NotificationSettingsPage',
      id: 'NotificationSettingsPageTab',
      linkProps: {
