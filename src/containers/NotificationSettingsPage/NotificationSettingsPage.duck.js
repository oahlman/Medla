...
export const CLEAR_UPDATED_FORM = 'app/NotificationSettingsPage/CLEAR_UPDATED_FORM';

export const UPLOAD_IMAGE_REQUEST = 'app/NotificationSettingsPage/UPLOAD_IMAGE_REQUEST';
export const UPLOAD_IMAGE_SUCCESS = 'app/NotificationSettingsPage/UPLOAD_IMAGE_SUCCESS';
export const UPLOAD_IMAGE_ERROR = 'app/NotificationSettingsPage/UPLOAD_IMAGE_ERROR';

export const UPDATE_PROFILE_REQUEST = 'app/NotificationSettingsPage/UPDATE_PROFILE_REQUEST';
export const UPDATE_PROFILE_SUCCESS = 'app/NotificationSettingsPage/UPDATE_PROFILE_SUCCESS';
export const UPDATE_PROFILE_ERROR = 'app/NotificationSettingsPage/UPDATE_PROFILE_ERROR';
  ...
  return (dispatch, getState, sdk) => {
    ...
    return sdk.currentUser
      ...
      .then(response => {
        ...
        dispatch(updateCompanyListing(response));
      })
