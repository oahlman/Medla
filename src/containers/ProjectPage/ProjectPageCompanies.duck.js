...
export const FETCH_LISTINGS_REQUEST = 'app/ProjectPage/FETCH_LISTINGS_REQUEST';
export const FETCH_LISTINGS_SUCCESS = 'app/ProjectPage/FETCH_LISTINGS_SUCCESS';
export const FETCH_LISTINGS_ERROR = 'app/ProjectPage/FETCH_LISTINGS_ERROR';

export const OPEN_LISTING_REQUEST = 'app/ProjectPage/OPEN_LISTING_REQUEST';
export const OPEN_LISTING_SUCCESS = 'app/ProjectPage/OPEN_LISTING_SUCCESS';
export const OPEN_LISTING_ERROR = 'app/ProjectPage/OPEN_LISTING_ERROR';

export const CLOSE_LISTING_REQUEST = 'app/ProjectPage/CLOSE_LISTING_REQUEST';
export const CLOSE_LISTING_SUCCESS = 'app/ProjectPage/CLOSE_LISTING_SUCCESS';
export const CLOSE_LISTING_ERROR = 'app/ProjectPage/CLOSE_LISTING_ERROR';

export const ADD_OWN_ENTITIES = 'app/ProjectPage/ADD_OWN_ENTITIES';
 ...
 */
export const getCompaniesById = (state, listingIds) => {
  const { ownEntities } = state.ProjectPage;
...
export const queryListings = queryParams => (dispatch, getState, sdk) => {
  ...
  const params = { 'pub_listingCategory': 'company', ...rest, per_page: perPage };
