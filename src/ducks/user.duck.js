...
const randomCode = Math.floor(Math.random() * (999999 - 111111) + 111111);
...
export const sendVerificationCode = () => (dispatch, getState, sdk) => {
  return sdk.currentUser
    .updateProfile({
      privateData: {
...
export const verifyPhoneNumber = () => (dispatch, getState, sdk) => {
  return sdk.currentUser
    .updateProfile({
      privateData: {
