...
const EditCompanyDescriptionFormComponent = props => (
  <FinalForm
    {...props}
...
EditCompanyDescriptionFormComponent.defaultProps = { className: null, fetchErrors: null };

EditCompanyDescriptionFormComponent.propTypes = {
  className: string,
...
export default compose(injectIntl)(EditCompanyDescriptionFormComponent);
